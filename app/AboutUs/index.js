      ...
      <Container style={styles.container}>
        ...
        <Content>
          <View style={styles.mainView}>
            ...
            <Text
              style={[styles.textRowAns, { marginTop: Metrics.HEIGHT * 0.015 }]}
            >
            ...
            <View
              style={[styles.stepView, { marginTop: Metrics.HEIGHT * 0.02 }]}
            >
            ...
            >
              ...
              <Text style={styles.textRowAns}>
                ...
                nihil impedit quominus id quod maxime placeat facere
              </Text>
            </View>
            <View
              style={[styles.stepView, { marginTop: Metrics.HEIGHT * 0.02 }]}
            >
              ...
              <Text style={styles.textRowAns}>Neque porro quisquam</Text>
            </View>
